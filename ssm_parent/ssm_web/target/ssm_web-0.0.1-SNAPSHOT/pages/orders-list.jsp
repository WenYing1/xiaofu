                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            ...
                            <select class="form-control" id="changePageSize" onchange="changePageSize()">
                                 <option>
                                <c:if test="${pageInfo.pageSize==1 }" ><option selected="selected"></c:if>
                                1</option>
                                <option><c:if test="${pageInfo.pageSize==2 }" ><option selected="selected"></c:if>2</option>
                                <option><c:if test="${pageInfo.pageSize==3 }" ><option selected="selected"></c:if>3</option>
                                <option><c:if test="${pageInfo.pageSize==4 }" ><option selected="selected"></c:if>4</option>
                                <option><c:if test="${pageInfo.pageSize==5 }" ><option selected="selected"></c:if>5</option>
                            </select> 条
                        </div>
                    </div>
